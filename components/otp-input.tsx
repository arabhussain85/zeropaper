...
export default function OTPInput({ length = 4, value, onChange, disabled = false, autoFocus = true }: OTPInputProps) {
      ...
      {Array.from({ length }).map((_, index) => (
        ...
        >
          <Input
            ...
            disabled={disabled}
            className="h-14 w-14 text-center text-xl font-bold bg-gray-50 focus:ring-2 focus:ring-[#1B9D65]"
